...
import { eliminarEvento, obtenerEvento } from '../Firebase/Promesas';
...
export const Eliminar = () => {
    ...
    return (
        <form className='form'>
            ...
            <button className='btn' onClick={eliminarContacto} type="button">Eliminar</button>
        </form>
      )
